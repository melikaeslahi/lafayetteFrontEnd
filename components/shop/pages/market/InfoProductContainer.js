...
const InfoProductContainer =({title , children ,className})=>{
    return(
        <>
        <section className="flex flex-col p-3  w-full        border my-2 border-gray-300  shadow-lg shadow-gray-200  rounded-lg " >
