...
const SMSSchema = Yup.object({
    title: Yup.string().min(2, ' موضوع انتخاب شده باید بیشتر از 2 کارکتر باشد').max(100, ' موضوع انتخاب شده باید  کمتر  از  100  کارکتر   باشد').required('   وارد کردن موضوع   الزامی است'),
