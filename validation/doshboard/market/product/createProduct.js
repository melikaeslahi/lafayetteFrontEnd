...
const CreateProductSchema = Yup.object({
    ...
    price: Yup.number().required('وارد کردن قیمت محصول اجباری است'),
    ...
    introduction: Yup.string().min(2, 'نام انتخاب شده باید بیشتر از 2 کارکتر باشد').max(250, 'نام انتخاب شده باید  کمتر  از  100  کارکتر   باشد').required('توضیحات خود را وارد نمایید'),

    status: Yup.number(),
    marketable: Yup.number(),
